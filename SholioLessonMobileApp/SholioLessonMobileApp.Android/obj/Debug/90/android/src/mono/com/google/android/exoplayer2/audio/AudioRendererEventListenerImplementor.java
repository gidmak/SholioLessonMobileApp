...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onAudioDecoderInitialized:(Ljava/lang/String;JJ)V:GetOnAudioDecoderInitialized_Ljava_lang_String_JJHandler:Com.Google.Android.Exoplayer2.Audio.IAudioRendererEventListenerInvoker, ExoPlayer.Core\n" +
			"n_onAudioDisabled:(Lcom/google/android/exoplayer2/decoder/DecoderCounters;)V:GetOnAudioDisabled_Lcom_google_android_exoplayer2_decoder_DecoderCounters_Handler:Com.Google.Android.Exoplayer2.Audio.IAudioRendererEventListenerInvoker, ExoPlayer.Core\n" +
			"n_onAudioEnabled:(Lcom/google/android/exoplayer2/decoder/DecoderCounters;)V:GetOnAudioEnabled_Lcom_google_android_exoplayer2_decoder_DecoderCounters_Handler:Com.Google.Android.Exoplayer2.Audio.IAudioRendererEventListenerInvoker, ExoPlayer.Core\n" +
			"n_onAudioInputFormatChanged:(Lcom/google/android/exoplayer2/Format;)V:GetOnAudioInputFormatChanged_Lcom_google_android_exoplayer2_Format_Handler:Com.Google.Android.Exoplayer2.Audio.IAudioRendererEventListenerInvoker, ExoPlayer.Core\n" +
