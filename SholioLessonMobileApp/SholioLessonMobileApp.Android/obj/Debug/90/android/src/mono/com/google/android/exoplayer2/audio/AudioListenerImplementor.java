...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onAudioAttributesChanged:(Lcom/google/android/exoplayer2/audio/AudioAttributes;)V:GetOnAudioAttributesChanged_Lcom_google_android_exoplayer2_audio_AudioAttributes_Handler:Com.Google.Android.Exoplayer2.Audio.IAudioListenerInvoker, ExoPlayer.Core\n" +
			"n_onAudioSessionId:(I)V:GetOnAudioSessionId_IHandler:Com.Google.Android.Exoplayer2.Audio.IAudioListenerInvoker, ExoPlayer.Core\n" +
			"n_onVolumeChanged:(F)V:GetOnVolumeChanged_FHandler:Com.Google.Android.Exoplayer2.Audio.IAudioListenerInvoker, ExoPlayer.Core\n" +
			"";
